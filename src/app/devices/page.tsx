...
export default function DevicesPage() {
  ...
  // ✅ IMPORTANT: warm state before first toggle so gangCount + keys are correct
  async function warmState(device: AnyDevice) {
    ...
    try {
      ...
      // fail silently (still allow command attempt)
    }
  }
  ...
  // ✅ WORKING COMMAND LOGIC (same as your working page)
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <GangRingSwitch
                      ...
                      values={ringValues}
                      busy={isBusy}
                      // ✅ This calls the working toggle logic
